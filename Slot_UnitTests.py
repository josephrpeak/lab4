...
class TestLabFunctions(unittest.TestCase):
    ...
    def test_get_payout_returns_correct_results(self):
        ...
        self.assertEqual(20, results, "get_payout returns 8 when given 2 and 3 matches.")
        results = lab04.get_payout(5, 2)
        self.assertEqual(15, results, "get_payout returns 10 when given 5 and 2 matches.")
